...
public class HeapSort {
    public static void main(String[] args) {
        ...
        HeapSortⅤ heapSortⅤ = new HeapSortⅤ();
        int[] ints5 = heapSortⅤ.heapSort(new int[]{3, 5, 1, 3, 9, 7, 5, 6, -1});
        System.out.println(Arrays.toString(ints5));
        HeapSortⅥ heapSortⅥ = new HeapSortⅥ();
        int[] ints6 = heapSortⅥ.heapSort(new int[]{3, 5, 1, 3, 9, 7, 5, 6, -1});
        System.out.println(Arrays.toString(ints6));
        HeapSortⅦ heapSortⅦ = new HeapSortⅦ();
        int[] ints7 = heapSortⅦ.heapSort(new int[]{3, 5, 1, 3, 9, 7, 5, 6, -1},3);
        System.out.println(Arrays.toString(ints7));
        HeapSort1 heapSort1 = new HeapSort1();
        int[] ints8 = heapSort1.heapSort(new int[]{3, 5, 1, 3, 9, 7, 5, 6, -1});
