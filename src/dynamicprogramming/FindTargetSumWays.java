...
public class FindTargetSumWays {
    public static void main(String[] args) {
        ...
        FindTargetSumWaysⅡ findTargetSumWaysⅡ = new FindTargetSumWaysⅡ();
        System.out.println(findTargetSumWaysⅡ.findTargetSumWays(new int[]{100}, -200));
    }
